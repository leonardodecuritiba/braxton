 ...
 * Generated for Laravel 5.5.35 on 2018-02-25 14:57:57.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function success($message, $data = null, $route = null, $status = 200)
        {
            return \Illuminate\Routing\ResponseFactory::success($message, $data, $route, $status);
        }
        ...
        {
            return \Illuminate\Routing\ResponseFactory::error($errors, $status);
        }
